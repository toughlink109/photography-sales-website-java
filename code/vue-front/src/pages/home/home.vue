...
<div class="home-preview" :style='{"width":"100%","margin":"0 auto","flexDirection":"column","display":"flex"}'>
		...
		<div id="about" class="animate__animated" :style='{"padding":"100px 10% 100px 45%","boxShadow":"none","margin":"0 0 10px","display":"flex","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240111/a157ad1a3608480a9d2e42426e83c029.png)","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","position":"relative","backgroundRepeat":"no-repeat","height":"auto","order":"7"}'>
		  ...
		  <div :style='{"width":"285px","background":"url(https://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg) 0% 0% / cover no-repeat","display":"none","height":"100px"}' />
...
<!--		</div>-->
	...
	<div id="animate_newsnews" class="news animate__animated" :style='{"width":"80%","margin":"0 auto 10px","position":"relative","background":"#fff","order":"3"}'>
		...
		<div class="title" :style='{"border":"4px solid #FFC174","padding":"0 30px","margin":"10px auto","borderRadius":"30px","textAlign":"left","background":"linear-gradient(180deg, #10615F 0%, #0A4742 100%)","width":"100%","lineHeight":"54px"}'>
			<span :style='{"color":"#FFC174","fontSize":"24px","fontWeight":"bold"}'>新闻资讯</span>
		</div>
		...
		<div v-if="newsList.length" class="list list5 index-pv1" :style='{"width":"100%","padding":"10px","background":"#fff","height":"auto"}'>
		  <div @click="toDetail('newsDetail', newsList[0])" v-if="newsList.length>0" class="list-item animation-box" :style='{"width":"100%","margin":"0 0 30px","alignItems":"center","background":"#fff","display":"flex","height":"auto"}'>
		    ...
		    <div :style='{"width":"calc(100% - 30vw)","padding":"0 20px","background":"#fff","flexDirection":"column","display":"flex","height":"auto"}'>
			  ...
			  <div :style='{"padding":"6px 0","order":"4"}'>
			    ...
			    <span class="text" :style='{"color":"#4D4D4D","lineHeight":"1.5","fontSize":"14px"}'>{{newsList[0].favoriteCount}}</span>
			  </div>
		  ...
		  <div :style='{"width":"100%","flexWrap":"wrap","background":"#fff","justifyContent":"space-between","display":"flex","height":"auto"}' class="list-body">
		    <div @click="toDetail('newsDetail', newsList[1])" v-if="newsList.length>1" class="new5-item animation-box" :style='{"border":"5px solid #FFC174","padding":"20px","borderRadius":"30px","background":"#fff","flexDirection":"column","display":"flex","width":"32%","position":"relative","height":"auto"}'>
			  ...
			  <div :style='{"padding":"6px 0","order":"4"}'>
			    <span class="icon iconfont icon-shoucang10" :style='{"margin":"0 4px 0 0","lineHeight":"1.5","fontSize":"14px","color":"#4D4D4D"}'></span>
			    <span class="text" :style='{"color":"#4D4D4D","lineHeight":"1.5","fontSize":"14px"}'>{{newsList[1].favoriteCount}}</span>
			  </div>
			  <div :style='{"padding":"0 0","order":"5"}'>
			    <span class="icon iconfont icon-chakan9" :style='{"margin":"0 4px 0 0","lineHeight":"1.5","fontSize":"14px","color":"#4D4D4D"}'></span>
			...
			<div @click="toDetail('newsDetail', newsList[2])" v-if="newsList.length>2" class="new5-item animation-box" :style='{"border":"5px solid #FFC174","padding":"20px","borderRadius":"30px","background":"#fff","flexDirection":"column","display":"flex","width":"32%","position":"relative","height":"auto"}'>
			  ...
			  <div :style='{"padding":"6px 0","order":"4"}'>
			    <span class="icon iconfont icon-shoucang10" :style='{"margin":"0 4px 0 0","lineHeight":"1.5","fontSize":"14px","color":"#4D4D4D"}'></span>
			    <span class="text" :style='{"color":"#4D4D4D","lineHeight":"1.5","fontSize":"14px"}'>{{newsList[2].favoriteCount}}</span>
			  </div>
			  <div :style='{"padding":"0 0","order":"5"}'>
			    <span class="icon iconfont icon-chakan9" :style='{"margin":"0 4px 0 0","lineHeight":"1.5","fontSize":"14px","color":"#4D4D4D"}'></span>
			...
			<div @click="toDetail('newsDetail', newsList[3])" v-if="newsList.length>3" class="new5-item animation-box" :style='{"border":"5px solid #FFC174","padding":"20px","borderRadius":"30px","background":"#fff","flexDirection":"column","display":"flex","width":"32%","position":"relative","height":"auto"}'>
			  ...
			  <div :style='{"padding":"6px 0","order":"4"}'>
			    <span class="icon iconfont icon-shoucang10" :style='{"margin":"0 4px 0 0","lineHeight":"1.5","fontSize":"14px","color":"#4D4D4D"}'></span>
			    <span class="text" :style='{"color":"#4D4D4D","lineHeight":"1.5","fontSize":"14px"}'>{{newsList[3].favoriteCount}}</span>
			  </div>
			  <div :style='{"padding":"0 0","order":"5"}'>
			    <span class="icon iconfont icon-chakan9" :style='{"margin":"0 4px 0 0","lineHeight":"1.5","fontSize":"14px","color":"#4D4D4D"}'></span>
...
<!-- 商品推荐 -->
<div id="animate_recommendphotographyWorks" class="recommend animate__animated" :style='{"margin":"20px 0","position":"relative","background":"#fff","order":"4"}'>
    ...
    <div class="title" :style='{"width":"100%","padding":"0 10%","margin":"10px auto","lineHeight":"140px","textAlign":"left","background":"#8E4033"}'>
		<span :style='{"color":"#fff","fontSize":"28px"}'>摄影作品推荐</span>
	</div>
	...
	<div v-if="photographyWorksRecommend.length" class="list list12 index-pv1 list12photographyWorks" :style='{"width":"100%","padding":"10px 10%","background":"#fff","height":"auto"}'>
	  <div class="list" :style='{"overflow":"hidden","flex":"1","background":"#fff","justifyContent":"space-between","display":"flex","height":"auto"}'>
	    <div :style='{"border":"5px solid #FFC174","padding":"10px","borderRadius":"30px","background":"#5F848D","width":"16%","position":"relative","height":"auto"}' class="item list-item animation-box" v-for="item,index in photographyWorksRecommend" :key="index" @click="toDetail('photographyWorksDetail', item)">
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"230px"}' v-if="preHttp(item.coverImage)" :src="item.coverImage.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"230px"}' v-else :src="baseUrl + (item.coverImage?item.coverImage.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"5px 10px 0","lineHeight":"1.5","fontSize":"18px","color":"#fff","textAlign":"center"}'>{{item.workName}}</div>
			<div class="line1" :style='{"padding":"5px 10px 0","lineHeight":"1.5","fontSize":"18px","color":"#fff","textAlign":"center"}'>{{item.workCategory}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('photographyWorks')" :style='{"border":"0","cursor":"pointer","margin":"10px auto","top":"55px","textAlign":"center","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute","right":"calc(10% + 10px)"}'>
		<span :style='{"color":"#f5f5f5","fontSize":"16px"}'>更多</span>
		<i :style='{"color":"#f5f5f5","borderRadius":"100%","background":"#FFC174","display":"inline-block","width":"30px","fontSize":"12px","height":"30px"}' class="icon iconfont icon-gengduo1"></i>
	</div>
...
<!-- 商品推荐 -->
<div id="animate_recommendphotographyEquipments" class="recommend animate__animated" :style='{"margin":"20px 0","position":"relative","background":"#fff","order":"4"}'>
	<div v-if="false" class="idea recommendIdea" :style='{"padding":"20px","flexWrap":"wrap","background":"#efefef","justifyContent":"space-between","display":"flex"}'>
		<div class="box1" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box2" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box3" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
    ...
    <div class="title" :style='{"width":"100%","padding":"0 10%","margin":"10px auto","lineHeight":"140px","textAlign":"left","background":"#8E4033"}'>
		<span :style='{"color":"#fff","fontSize":"28px"}'>摄影设备推荐</span>
	</div>
	...
	<div v-if="photographyEquipmentsRecommend.length" class="list list12 index-pv1 list12photographyEquipments" :style='{"width":"100%","padding":"10px 10%","background":"#fff","height":"auto"}'>
	  <div class="list" :style='{"overflow":"hidden","flex":"1","background":"#fff","justifyContent":"space-between","display":"flex","height":"auto"}'>
	    <div :style='{"border":"5px solid #FFC174","padding":"10px","borderRadius":"30px","background":"#5F848D","width":"16%","position":"relative","height":"auto"}' class="item list-item animation-box" v-for="item,index in photographyEquipmentsRecommend" :key="index" @click="toDetail('photographyEquipmentsDetail', item)">
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"230px"}' v-if="preHttp(item.image)" :src="item.image.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"230px"}' v-else :src="baseUrl + (item.image?item.image.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"5px 10px 0","lineHeight":"1.5","fontSize":"18px","color":"#fff","textAlign":"center"}'>{{item.equipmentName}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('photographyEquipments')" :style='{"border":"0","cursor":"pointer","margin":"10px auto","top":"55px","textAlign":"center","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute","right":"calc(10% + 10px)"}'>
		<span :style='{"color":"#f5f5f5","fontSize":"16px"}'>更多</span>
		<i :style='{"color":"#f5f5f5","borderRadius":"100%","background":"#FFC174","display":"inline-block","width":"30px","fontSize":"12px","height":"30px"}' class="icon iconfont icon-gengduo1"></i>
	</div>
...
<!-- 商品推荐 -->
<div id="animate_recommendphotographyTopics" class="recommend animate__animated" :style='{"margin":"20px 0","position":"relative","background":"#fff","order":"4"}'>
	<div v-if="false" class="idea recommendIdea" :style='{"padding":"20px","flexWrap":"wrap","background":"#efefef","justifyContent":"space-between","display":"flex"}'>
		<div class="box1" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box2" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box3" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
    ...
    <div class="title" :style='{"width":"100%","padding":"0 10%","margin":"10px auto","lineHeight":"140px","textAlign":"left","background":"#8E4033"}'>
		<span :style='{"color":"#fff","fontSize":"28px"}'>摄影话题推荐</span>
	</div>
	...
	<div v-if="photographyTopicsRecommend.length" class="list list12 index-pv1 list12photographyTopics" :style='{"width":"100%","padding":"10px 10%","background":"#fff","height":"auto"}'>
	  <div class="list" :style='{"overflow":"hidden","flex":"1","background":"#fff","justifyContent":"space-between","display":"flex","height":"auto"}'>
	    <div :style='{"border":"5px solid #FFC174","padding":"10px","borderRadius":"30px","background":"#5F848D","width":"16%","position":"relative","height":"auto"}' class="item list-item animation-box" v-for="item,index in photographyTopicsRecommend" :key="index" @click="toDetail('photographyTopicsDetail', item)">
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"230px"}' v-if="preHttp(item.coverImage)" :src="item.coverImage.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"230px"}' v-else :src="baseUrl + (item.coverImage?item.coverImage.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"5px 10px 0","lineHeight":"1.5","fontSize":"18px","color":"#fff","textAlign":"center"}'>{{item.title}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('photographyTopics')" :style='{"border":"0","cursor":"pointer","margin":"10px auto","top":"55px","textAlign":"center","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute","right":"calc(10% + 10px)"}'>
		<span :style='{"color":"#f5f5f5","fontSize":"16px"}'>更多</span>
		<i :style='{"color":"#f5f5f5","borderRadius":"100%","background":"#FFC174","display":"inline-block","width":"30px","fontSize":"12px","height":"30px"}' class="icon iconfont icon-gengduo1"></i>
	</div>
...
<!-- 商品推荐 -->
<div id="animate_recommendworkPublish" class="recommend animate__animated" :style='{"margin":"20px 0","position":"relative","background":"#fff","order":"4"}'>
	<div v-if="false" class="idea recommendIdea" :style='{"padding":"20px","flexWrap":"wrap","background":"#efefef","justifyContent":"space-between","display":"flex"}'>
		<div class="box1" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box2" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box3" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
    ...
    <div class="title" :style='{"width":"100%","padding":"0 10%","margin":"10px auto","lineHeight":"140px","textAlign":"left","background":"#8E4033"}'>
		<span :style='{"color":"#fff","fontSize":"28px"}'>作品发布推荐</span>
	</div>
	...
	<div v-if="workPublishRecommend.length" class="list list12 index-pv1 list12workPublish" :style='{"width":"100%","padding":"10px 10%","background":"#fff","height":"auto"}'>
	  <div class="tab" :style='{"width":"100%","margin":"0 0 20px","justifyContent":"space-between","display":"flex","height":"auto"}'>
	    <template v-for="item,index in recommendList12workPublish">
		<div v-if="index < 6" @click="recommendIndexClick12(index + 1, 'workPublish')" class="item" :class="index + 1 == recommendIndex12workPublish ? 'active' : ''">
			<img v-if="item.image" :style='{"width":"60px","margin":"0 0 10px","objectFit":"cover","borderRadius":"50%","display":"block","height":"60px"}' :src="baseUrl + (item.image?item.image.split(',')[0]:'')">
			<div :style='{"color":"inherit","fontSize":"inherit"}'>{{item[recommendColumn12workPublish]}}</div>
		</div>
		</template>
		<div class="more" @click="moreBtn('workPublish')">
		  <div :style='{"color":"#FFC174","fontSize":"16px","fontWeight":"bold"}'>更多</div>
		  <span class="icon iconfont icon-jiantou25" :style='{"margin":"0 0 0 6px","color":"#fff","borderRadius":"50%","textAlign":"center","background":"#FFC174","width":"30px","fontSize":"16px","lineHeight":"30px","height":"30px"}'></span>
		</div>
	  </div>
	  <div class="list" :style='{"overflow":"hidden","flex":"1","background":"#fff","justifyContent":"space-between","display":"flex","height":"auto"}'>
	    <div :style='{"border":"5px solid #FFC174","padding":"10px","borderRadius":"30px","background":"#5F848D","width":"16%","position":"relative","height":"auto"}' class="item list-item animation-box" v-for="item,index in workPublishRecommend" :key="index" @click="toDetail('workPublishDetail', item)">
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"230px"}' v-if="preHttp(item.work)" :src="item.work.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"230px"}' v-else :src="baseUrl + (item.work?item.work.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"5px 10px 0","lineHeight":"1.5","fontSize":"18px","color":"#fff","textAlign":"center"}'>{{item.title}}</div>
			<div class="line1" :style='{"padding":"5px 10px 0","lineHeight":"1.5","fontSize":"18px","color":"#fff","textAlign":"center"}'>{{item.workCategory}}</div>
	    </div>
	  </div>
	...
	<div @click="moreBtn('workPublish')" :style='{"border":"0","cursor":"pointer","margin":"10px auto","top":"55px","textAlign":"center","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute","right":"calc(10% + 10px)"}'>
		<span :style='{"color":"#f5f5f5","fontSize":"16px"}'>更多</span>
		<i :style='{"color":"#f5f5f5","borderRadius":"100%","background":"#FFC174","display":"inline-block","width":"30px","fontSize":"12px","height":"30px"}' class="icon iconfont icon-gengduo1"></i>
	</div>
...
<!-- 特价商品 -->
<div id="animate_listphotographyEquipments" class="lists animate__animated" :style='{"margin":"0 0 10px","position":"relative","background":"#fff","order":"6"}'>
	...
	<div class="title" :style='{"padding":"0 10% 0 13%","margin":"0 auto","textAlign":"left","background":"url(http://codegen.caihongy.cn/20240110/a4f11fd0784b43bc85f01dba4285b590.png)","width":"100%","lineHeight":"90px","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"90px"}'>
	  <span :style='{"color":"#1D3F48","fontSize":"36px"}'>摄影设备展示</span>
	</div>
	...
	<div v-if="photographyEquipmentsList.length" class="list list11 index-pv1" :style='{"padding":"20px 0","margin":"0 auto","alignItems":"flex-start","background":"#fff","display":"flex","width":"80%","justifyContent":"space-between","height":"auto"}'>
	  <div class="list" :style='{"flexWrap":"wrap","flex":"1","background":"#fff","justifyContent":"space-between","display":"flex","height":"auto"}'>
	    <div :style='{"border":"5px solid #FFC174","padding":"10px","margin":"0 0 30px","borderRadius":"30px","background":"#5F848D","width":"31%","position":"relative","height":"auto"}' class="item list-item animation-box" v-for="item,index in photographyEquipmentsList" :key="index" @click="toDetail('photographyEquipmentsDetail', item)">
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"300px"}' v-if="preHttp(item.image)" :src="item.image.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"300px"}' v-else :src="baseUrl + (item.image?item.image.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"2","fontSize":"18px","color":"#fff","textAlign":"center"}'>{{item.equipmentName}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('photographyEquipments')" :style='{"border":"0","padding":"0 30px","margin":"10px auto","alignItems":"center","textAlign":"center","display":"flex","right":"10%","top":"0","borderRadius":"40px","background":"#8E4033","width":"auto","lineHeight":"70px","position":"absolute","height":"70px"}'>
		<span :style='{"color":"#fff","fontSize":"16px"}'>查看更多</span>
		<i :style='{"margin":"0 0 0 6px","color":"#f5f5f5","borderRadius":"50%","alignItems":"center","background":"#FFC174","display":"flex","width":"30px","fontSize":"16px","justifyContent":"center","height":"30px"}' class="icon iconfont icon-gengduo1"></i>
	</div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        newsList: [],
        photographyWorksRecommend: [],
        photographyEquipmentsRecommend: [],
        photographyTopicsRecommend: [],
        workPublishRecommend: [],

        photographyEquipmentsList: [],


		recommendIndex12photographyWorks: 0,
		recommendList12photographyWorks: [],
		recommendColumn12photographyWorks: '',
		recommendIndex12photographyTopics: 0,
		recommendList12photographyTopics: [],
		recommendColumn12photographyTopics: '',
		recommendIndex12workPublish: 0,
		recommendList12workPublish: [],
		recommendColumn12workPublish: '',
    ...
    created() {
		...
		this.getList();
		this.photographyWorksRecommendCate()
		this.photographyTopicsRecommendCate()
		this.workPublishRecommendCate()
    },
	mounted() {
    ...
    methods: {
		...
		photographyWorksRecommendCate(){
			this.$http.get('workCategory/list',{}).then(res => {
			  if (res.data.code == 0) {
				this.recommendList12photographyWorks = res.data.data.list
			  }
			});
			this.recommendColumn12photographyWorks = 'workCategory'
		},
		photographyTopicsRecommendCate(){
			this.$http.get('topicCategories/list',{}).then(res => {
			  if (res.data.code == 0) {
				this.recommendList12photographyTopics = res.data.data.list
			  }
			});
			this.recommendColumn12photographyTopics = 'topicCategories'
		},
		workPublishRecommendCate(){
			this.$http.get('workCategory/list',{}).then(res => {
			  if (res.data.code == 0) {
				this.recommendList12workPublish = res.data.data.list
			  }
			});
			this.recommendColumn12workPublish = 'workCategory'
		},
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendphotographyWorks',css:'animate__jackInTheBox'},
				{id:'animate_recommendphotographyEquipments',css:'animate__jackInTheBox'},
				{id:'animate_listphotographyEquipments',css:'animate__fadeInRight'},
				{id:'animate_recommendphotographyTopics',css:'animate__jackInTheBox'},
				{id:'animate_recommendworkPublish',css:'animate__jackInTheBox'},
      ...
      getSystemIntroduction() {
		...
		getList() {
			let autoSortUrl = "";
			let data = {}
          autoSortUrl = "photographyWorks/autoSort";
          if(localStorage.getItem('frontToken')) {
              autoSortUrl = "photographyWorks/autoSort2";
          }
			data = {
				page: 1,
				limit: 6,
			}
			if(this.recommendIndex12photographyWorks != 0){
				data.workCategory = this.recommendList12photographyWorks[this.recommendIndex12photographyWorks - 1].workCategory
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.photographyWorksRecommend = res.data.data.list;
          ...
          autoSortUrl = "photographyEquipments/autoSort";
			data = {
				page: 1,
				limit: 6,
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.photographyEquipmentsRecommend = res.data.data.list;
          ...
          autoSortUrl = "photographyTopics/autoSort";
          if(localStorage.getItem('frontToken')) {
              autoSortUrl = "photographyTopics/autoSort2";
          }
			data = {
				page: 1,
				limit: 6,
			...
			data['isApproved'] = '是'
			if(this.recommendIndex12photographyTopics != 0){
				data.topicCategories = this.recommendList12photographyTopics[this.recommendIndex12photographyTopics - 1].topicCategories
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.photographyTopicsRecommend = res.data.data.list;
          ...
          autoSortUrl = "workPublish/autoSort";
			data = {
				page: 1,
				limit: 6,
			}
			data['isApproved'] = '是'
			if(this.recommendIndex12workPublish != 0){
				data.workCategory = this.recommendList12workPublish[this.recommendIndex12workPublish - 1].workCategory
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.workPublishRecommend = res.data.data.list;
			...
			this.$http.get('photographyEquipments/list', {params: data}).then(res => {
				if (res.data.code == 0) {
					this.photographyEquipmentsList = res.data.data.list;

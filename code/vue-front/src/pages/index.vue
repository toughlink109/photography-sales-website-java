<template>
  <div class="main-containers">
    <div class="body-containers"
         :style='{"minHeight":"100vh","padding":"88px 0 0","margin":"0","background":"url(http://codegen.caihongy.cn/20240111/d1e1436a001445b08c5508f0bb6e20a4.png)","backgroundSize":"100% 100%","position":"relative","backgroundPosition":"center center","backgroundRepeat":"no-repeat"}'>
      <div class="top-container"
           :style='{"boxShadow":"none","padding":"0 20px","alignItems":"flex-start","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","left":"0","background":"#8E4033","width":"100%","position":"fixed","height":"88px","zIndex":"1002"}'>
        <!-- info -->
        <div
            :style='{"padding":"0","top":"30px","left":"20px","background":"none","display":"block","width":"35%","position":"absolute"}'>
          <span @click="goMenu('/index/home')"
                :style='{"padding":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","width":"100%","lineHeight":"auto","fontSize":"18px","float":"left","fontWeight":"bold","justifyContent":"center"}'>基于Java的个人摄影作品管理网站</span>
        </div>
        ...
        <el-button v-if="Token" class="btn-shop" @click.native="goMenu('/index/cart')">
          <span class="icon iconfont icon-wuliu8"
                :style='{"color":"inherit","margin":"0 4px 0 0","fontSize":"15px"}'></span>
          购物车
        </el-button>

        <img v-if="headImage&&Token"
             :style='{"width":"44px","margin":"22px 10px 0 0","borderRadius":"50%","display":"inline-block","height":"44px"}'
             :src="headImage?baseUrl + headImage:require('@/assets/userAvatar.png')">
        <div v-if="Token"
             :style='{"padding":"0 0px","margin":"0 20px 0 0","fontSize":"15px","lineHeight":"88px","color":"#fff","height":"88px"}'>
          {{ username }}
        </div>
        <div v-if="Token && notAdmin"
             :style='{"padding":"0 0px","fontSize":"15px","lineHeight":"70px","color":"#fff","display":"none","height":"70px"}'
             @click="goMenu('/index/center')">个人中心
        </div>
        <el-button v-if="!Token" @click="toLogin()"
                   :style='{"border":"none","padding":"0 0px","margin":"0 20px 0 0","color":"#fff","borderRadius":"0","background":"none","display":"inline-block","fontSize":"14px","lineHeight":"88px","height":"88px"}'>
          登录/注册
        </el-button>
        <el-button v-if="Token" @click="logout"
                   :style='{"border":"none","padding":"0","margin":"0","color":"#fff","borderRadius":"0","background":"none","display":"inline-block","fontSize":"15px","lineHeight":"88px","height":"88px"}'>
          退出
        </el-button>
      </div>
      ...
      <div class="menu-preview"
           :style='{"padding":"0","borderColor":"#efefef","top":"0","left":"37%","background":"none","borderWidth":"0px 0 0","width":"calc(50% - 0px)","position":"fixed","borderStyle":"solid","zIndex":"1004"}'>
        <el-scrollbar wrap-class="scrollbar-wrapper-horizontal">
          <el-menu class="el-menu-horizontal-demo"
                   :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","background":"none","display":"flex","position":"relative"}'
                   :default-active="activeMenu" :unique-opened="true" mode="horizontal" :router="true"
                   @select="handleSelect">
            <div class="userinfo" :style='{"width":"84px","padding":"6px 10px 0","display":"none","height":"auto"}'>
              <el-image v-if="headImage&&Token"
                        :style='{"width":"100%","objectFit":"cover","borderRadius":"20px","display":"block","height":"32px"}'
                        :src="headImage?baseUrl + headImage:require('@/assets/userAvatar.png')" fit="cover"></el-image>
              <div :style='{"fontSize":"12px","lineHeight":"1.5","color":"#333","textAlign":"center"}'>{{ username }}
              </div>
            </div>
            <el-menu-item class="home" index="/index/home" @click.native="goMenu('/index/home')">
              <span
                  :style='{"padding":"0 0","margin":"0 8px 0 0","color":"inherit","display":"none","width":"14px","lineHeight":"1","fontSize":"inherit","height":"auto"}'
                  class="icon iconfont icon-shouye-zhihui"></span>
              <span
                  :style='{"padding":"0","lineHeight":"1","fontSize":"inherit","color":"inherit","height":"auto"}'>首页</span>
            </el-menu-item>
            <el-menu-item class="item" v-for="(menu, index) in menuList" :index="menu.url" :key="index"
                          @click.native="goMenu(menu.url)">
              <i :style='{"padding":"0","margin":"0 8px 0 0","color":"inherit","display":"none","width":"auto","lineHeight":"1","fontSize":"inherit","height":"auto"}'
                 :class="iconArr[index]"></i>
              <span
                  :style='{"padding":"0","lineHeight":"1","fontSize":"inherit","color":"inherit","height":"auto"}'>{{ menu.name }}</span>
            </el-menu-item>
            <el-menu-item class="shop" v-if="Token" index="/index/cart" @click.native="goMenu('/index/cart')">
              <span
                  :style='{"padding":"0 0","margin":"0 8px 0 0","color":"inherit","width":"auto","lineHeight":"1","fontSize":"inherit","height":"auto"}'
                  class="icon iconfont icon-wuliu8"></span>
            ...
            <el-menu-item class="user" index="/index/center" v-if="Token && notAdmin"
              ...
              <span
                  :style='{"padding":"0 0","margin":"0 8px 0 0","color":"inherit","display":"none","width":"auto","lineHeight":"56px","fontSize":"inherit","height":"56px"}'
                  class="icon iconfont icon-shouye-zhihui"></span>
              <span
                  :style='{"padding":"0 0","lineHeight":"56px","fontSize":"inherit","color":"inherit","height":"56px"}'>个人资料</span>
            </el-menu-item>
          </el-menu>
        </el-scrollbar>
      </div>
      ...
      <div
          :style='{"width":"100%","margin":"0 auto","flexWrap":"wrap","background":"#fff","display":"flex","height":"auto"}'>
        <div class="swiper21" :style='{"width":"100%","height":"auto","order":"2"}'>
          <div class="swiper-container mySwiper21">
            <div class="swiper-wrapper">
              <div class="swiper-slide" v-for="item in carouselList" :key="item.id">
                <div :style='{"width":"100%","height":"auto"}'>
                  <el-image v-if="preHttp(item.value)" @click="carouselClick(item.url)"
                            :style='{"objectFit":"cover","width":"100%","height":"500px"}' :src="item.value"
                            fit="cover"></el-image>
                  <el-image v-else @click="carouselClick(item.url)"
                            :style='{"objectFit":"cover","width":"100%","height":"500px"}' :src="baseUrl + item.value"
                            fit="cover"></el-image>
                </div>
              </div>
            </div>
        ...
        <div class="swiper22" :style='{"width":"100%","display":"none","height":"auto","order":"2"}'>
          <div class="swiper-container mySwiper22">
            <div class="swiper-wrapper">
              <div class="swiper-slide" v-for="item in carouselList" :key="item.id">
                <div>
                  <el-image v-if="preHttp(item.value)" :style='{"objectFit":"cover","width":"100%","height":"100px"}'
                            :src="item.value" fit="cover"></el-image>
                  <el-image v-else :style='{"objectFit":"cover","width":"100%","height":"100px"}'
            ...
            <div class="swiper-button-prev" :style='{"width":"14px","margin":"-7px 0 0","top":"50%","height":"14px"}'>
              <span class="icon iconfont icon-jiantou39"
                    :style='{"width":"14px","fontSize":"14px","color":"#fff","height":"14px"}'></span>
            </div>
      ...
      <div class="bottom-preview" :style='{"width":"100%","height":"auto"}'>
        <div
            :style='{"minHeight":"100px","width":"100%","padding":"20px","overflow":"hidden","background":"#000","height":"auto"}'>
...
export default {
  data() {
    return {
      ...
      roleMenus: [{
        "backMenu": [{
          ...
          "child": [{
            ...
            "buttons": ["查看", "删除", "日销量", "月销量", "日销额", "月销额", "退货审核"],
            "menu": "已完成订单",
      ...
      headImage: localStorage.getItem('frontHeadImage') ? localStorage.getItem('frontHeadImage') : '',
      Token: localStorage.getItem('frontToken'),
      username: localStorage.getItem('username'),
      notAdmin: localStorage.getItem('frontSessionTable') != '"admins"',
      timer: '',
      iconArr: [
        'el-icon-star-off',
        'el-icon-goods',
  ...
  methods: {
      ...
      await this.$http.get(`${localStorage.getItem('UserTableName')}/session`, {emulateJSON: true}).then(async res => {
        if (res.data.code == 0) {
          ...
          if (res.data.data.userAvatar) {
            this.headImage = res.data.data.userAvatar
            localStorage.setItem('frontHeadImage', res.data.data.userAvatar);
          } else if (res.data.data.headImage) {
            this.headImage = res.data.data.headImage
            localStorage.setItem('frontHeadImage', res.data.data.headImage);
          }
        }
      });
    },
    ...
    goBackend() {
      ...
      localStorage.setItem('headImage', localStorage.getItem('frontHeadImage'));

...
<div>
	<div :style='{"border":"5px solid #FFC174","width":"80%","padding":"25px 30px","margin":"10px auto","borderRadius":"30px","background":"linear-gradient(180deg, #10615F 0%, #0A4742 100%)"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'Ξ'" :style='{"fontSize":"14px","lineHeight":"1"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/photographyWorks"><a>{{item.name}}</a></el-breadcrumb-item>
	...
	<div class="detail-preview" :style='{"padding":"0 10%","margin":"10px auto","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","position":"relative"}'>
		<div class="attr" :style='{"border":"5px solid #FFC174","padding":"10px","borderRadius":"30px","background":"#fff","display":"flex","width":"45%","position":"relative","order":"2"}'>
			...
			<div class="info" :style='{"padding":"0","margin":"0","background":"#fff","flex":"1"}'>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","alignItems":"flex-start","background":"#fff","justifyContent":"space-between","display":"flex"}'>
					...
					<div @click="favorites(1)" v-show="!isFavorites" :style='{"padding":"0 10px","margin":"-20px 0 0","lineHeight":"60px","borderRadius":"0 0 20px 20px","background":"#0C4E49","height":"60px"}'><i v-if="true" :style='{"color":"#fff","fontSize":"14px"}' class="el-icon-star-off"></i><span :style='{"color":"#fff","fontSize":"14px"}'>点我收藏({{detail.favoriteCount}})</span></div>
					<div @click="favorites(-1)" v-show="isFavorites" :style='{"padding":"0 10px","margin":"-20px 0 0","lineHeight":"60px","borderRadius":"0 0 20px 20px","background":"#0C4E49","height":"60px"}'><i v-if="true" :style='{"color":"#fff","fontSize":"14px"}' class="el-icon-star-on"></i><span :style='{"color":"#fff","fontSize":"14px"}'>取消收藏({{detail.favoriteCount}})</span></div>
				</div>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					...
					<div :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","flex":"1","height":"auto"}'>{{detail.limitOne}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"width":"102px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","textAlign":"right"}'>库存</div>
					<div :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","flex":"1","height":"auto"}'>{{detail.goodsStocks}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"width":"102px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","textAlign":"right"}'>作品分类</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","flex":"1","height":"auto"}'>{{detail.workCategory}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"width":"102px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","textAlign":"right"}'>拍摄时间</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","flex":"1","height":"auto"}'>{{detail.shotTime}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"width":"102px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","textAlign":"right"}'>拍摄地点</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","flex":"1","height":"auto"}'>{{detail.shotLocation}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"width":"102px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","textAlign":"right"}'>发布日期</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","flex":"1","height":"auto"}'>{{detail.publishDate}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"width":"102px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","textAlign":"right"}'>投票票数</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#818181","flex":"1","height":"auto"}'>{{detail.voteCount}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#fff","justifyContent":"spaceBetween","display":"flex"}'>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-input-number :style='{"width":"180px","margin":"0 5px 0 0","lineHeight":"38px","position":"relative","display":"inline-block"}' v-if="detail.goodsStocks" :min=1 v-model="quantity"></el-input-number>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#000","borderRadius":"4px","background":"#FFC174","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="detail.goodsStocks" type="warning" size="small" @click="addCart">添加到购物车</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#000","borderRadius":"4px","background":"#FFC174","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="detail.goodsStocks" type="warning" size="small" @click="buyNow">立即购买</el-button>

				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#000","borderRadius":"4px","background":"#FFC174","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('photographyWorks','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#000","borderRadius":"4px","background":"#FFC174","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('photographyWorks','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#000","borderRadius":"4px","background":"#FFC174","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('photographyWorks','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#000","borderRadius":"4px","background":"#FFC174","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('photographyWorks','作品投票')" @click="onAcross('workVote','','','[1]','每人只能投一票')" type="warning">作品投票</el-button>
				</div>
			</div>
		</div>
		...
		<el-tabs class="detail" :style='{"border":"0px solid #DCDFE6","width":"100%","boxShadow":"none","background":"#FFF","order":"4"}' v-model="activeName" type="border-card">
			<el-tab-pane label="作品内容" name="first">
				<div v-html="detail.workContent"></div>
			</el-tab-pane>
  ...
  export default {
    ...
    methods: {
          ...
          this.$http.get(this.tableName + '/detail/'  + this.id, {}).then(res => {
            if (res.data.code == 0) {
              this.detail = res.data.data;
				this.title = this.detail.workName;
				this.detailBanner = this.detail.coverImage ? this.detail.coverImage.split(",") : [];
				this.$forceUpdate();
      ...
      async onAcross(acrossTable,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
        localStorage.setItem('crossTable',`photographyWorks`);
      ...
      favorites(type) {
        if (type == 1 && !this.isFavorites) {
          this.favoritesParams.name = this.title;
          this.favoritesParams.picture = this.detailBanner[0];
          this.favoritesParams.refId = this.detail.id;
          this.favoritesParams.type = type;
          this.$http.post('favorites/add', this.favoritesParams).then(res => {
            if (res.data.code == 0) {
              this.isFavorites = true;
			  this.detail.favoriteCount++
			  this.$http.post('photographyWorks/update', this.detail).then(res => {});
              this.$message({
                type: 'success',
                message: '收藏成功!',
                duration: 1500,
        ...
        if (type == -1 && this.isFavorites) {
          this.$http.get('favorites/list', {params: {page: 1, limit: 1, type: 1, refId: this.detail.id, tableName: 'photographyWorks', userId: localStorage.getItem('frontUserId')}}).then(res => {
            if (res.data.code == 0 && res.data.data.list.length > 0) {
              this.isFavorites = true;
              this.favoritesInfo = res.data.data.list[0];
              let delIds = new Array();
              delIds.push(this.favoritesInfo.id);
              this.$http.post('favorites/delete', delIds).then(res => {
                if (res.data.code == 0) {
    ...
    getThumbsupOrCrazilyStatus() {
        if(localStorage.getItem("frontToken")) {
            this.$http.get('favorites/list', {params: {page: 1, limit: 1, type: 21, refId: this.detail.id, tableName: 'photographyWorks', userId: localStorage.getItem('frontUserId')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
            ...
            this.$http.get('favorites/list', {params: {page: 1, limit: 1, type: 22, refId: this.detail.id, tableName: 'photographyWorks', userId: localStorage.getItem('frontUserId')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
      ...
      nextClick(page) {
		...
		backClick(){
			...
			this.$router.push({path: '/index/photographyWorks', query: params});
		},
		// 下载
		download(file){
			if(!file) {
      ...
      getDiscussList(page) {
        this.$http.get('discussWorkComments/list', {params: {page, limit: this.pageSize, refId: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
	  ...
	  discussDel(id){
		  this.$confirm('是否删除此评论？')
		    .then(_ => {
		      this.$http.post('discussWorkComments/delete',[id]).then(res=>{
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$http.get('orders/list', {params: {page: 1, limit: 1, status: '已完成', productId: this.detail.id, userId: localStorage.getItem('frontUserId')}}).then(res => {
                if (res.data.code == 0 && res.data.data.list.length == 0) {
                  this.$message({
                    type: 'success',
                    message: '请完成订单后再评论!',
                  ...
                  return false
                    ...
                    this.$http.post('discussWorkComments/add', this.form).then(res => {
						if (res.data.code == 0) {
      ...
      getCartList() {
        this.$http.get('cart/list', {params: {userId: localStorage.getItem('frontUserId'), tableName: 'photographyWorks', productId: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      addCart() {
            // 单次购买限制
            if (this.detail.limitOne > 0 && this.detail.limitOne < this.quantity) {
                this.$message.error(`每人单次只能购买${this.detail.limitOne}件`);
                return
            }
            // 库存不够
            if (this.detail.goodsStocks <= 0 ) {
                this.$message.error(`商品已售罄`);
                return
            }
            // 库存限制
            if (this.detail.goodsStocks > 0 && this.detail.goodsStocks < this.quantity) {
        ...
        this.cart.productId = this.detail.id;
        this.cart.productTitle = this.title;
		...
		// 修改
		editClick(){
			this.$router.push(`/index/photographyWorksAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		async delClick(){
			await this.$confirm('是否删除此摄影作品？')
			  .then(_ => {
			    this.$http.post('photographyWorks/delete', [this.detail.id]).then(async res => {
					if (res.data.code == 0) {
						this.$http.get('favorites/list',{params:{
							page: 1,
							limit: 100,
							...
							if(obj.data&&obj.data.code==0){
								...
								if(arr.length){
									await this.$http.post('favorites/delete',arr).then(()=>{})
								}
								this.$message({
									type: 'success',
									message: '删除成功!',

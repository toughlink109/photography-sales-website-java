		...
		<template v-if="showFlag">
			...
			<div :style='{"width":"100%","padding":"10px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="msgImage" width="200" label="留言图片">
						<template slot-scope="scope">
							<div v-if="scope.row.msgImage">
								<img v-if="scope.row.msgImage.substring(0,4)=='http'" :src="scope.row.msgImage.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.msgImage.split(',')[0])">
								<img v-else :src="$base.url+scope.row.msgImage.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView($base.url+scope.row.msgImage.split(',')[0])">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
					...
					<el-table-column :resizable='true' :sortable='true' prop="replyImage" width="200" label="回复图片">
						<template slot-scope="scope">
							<div v-if="scope.row.replyImage">
								<img v-if="scope.row.replyImage.substring(0,4)=='http'" :src="scope.row.replyImage.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.replyImage.split(',')[0])">
								<img v-else :src="$base.url+scope.row.replyImage.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView($base.url+scope.row.replyImage.split(',')[0])">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>

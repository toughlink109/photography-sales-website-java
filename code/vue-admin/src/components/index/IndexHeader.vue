<template>
	<div class="navbar">
		<div class="title" :style='{"display":"block"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"18px","color":"#fff","float":"left"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"fontSize":"14px","position":"absolute","right":"40px","color":"#666","display":"flex"}'>
		  <div class="el-dropdown-link" :style='{"alignItems":"center","display":"flex"}'>
		    <el-image v-if="user" :style='{"width":"32px","margin":"0 10px","objectFit":"cover","borderRadius":"100%","display":"none","height":"32px"}' :src="avatar?this.$base.url + avatar : require('@/assets/img/userAvatar.png')" fit="cover"></el-image>

					...
					<el-table-column :resizable='true' :sortable='true' prop="cpicture" width="200" label="留言图片">
						<template slot-scope="scope">
							<div v-if="scope.row.cpicture">
								<img v-if="scope.row.cpicture.substring(0,4)=='http'" :src="scope.row.cpicture.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.cpicture.split(',')[0])">
					...
					<el-table-column :resizable='true' :sortable='true' prop="rpicture" width="200" label="回复图片">
						<template slot-scope="scope">
							<div v-if="scope.row.rpicture">
								<img v-if="scope.row.rpicture.substring(0,4)=='http'" :src="scope.row.rpicture.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.rpicture.split(',')[0])">

	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="拍摄时间" prop="paisheshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.paisheshijian" label="拍摄时间" prop="paisheshijian">
					<el-input v-model="ruleForm.paisheshijian" placeholder="拍摄时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="拍摄地点" prop="paishedidian">
					<el-input v-model="ruleForm.paishedidian" placeholder="拍摄地点" clearable  :readonly="ro.paishedidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="拍摄地点" prop="paishedidian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="投票票数" prop="toupiaopiaoshu">
					<el-input v-model.number="ruleForm.toupiaopiaoshu" placeholder="投票票数" clearable  :readonly="ro.toupiaopiaoshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="投票票数" prop="toupiaopiaoshu">
					<el-input v-model="ruleForm.toupiaopiaoshu" placeholder="投票票数" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="作品内容" prop="zuopinneirong">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zuopinneirong" label="作品内容" prop="zuopinneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.zuopinneirong"></span>
                </el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.paisheshijian = this.getCurDateTime()
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.onelimittimes = Number('-1'); 				this.ruleForm.alllimittimes = Number('-1'); 				this.ruleForm.toupiaopiaoshu = Number('0'); 			}
			// 获取用户信息
			this.$http({
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zuopinneirong = this.ruleForm.zuopinneirong.replace(reg,'../../../springboottvfo8kua/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

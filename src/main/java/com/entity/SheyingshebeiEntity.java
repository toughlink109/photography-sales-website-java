...
public class SheyingshebeiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public SheyingshebeiEntity() {
		
	}
	
	public SheyingshebeiEntity(T t) {
		try {
	 ...
	 * 设置：小时租金
	 */
	public void setXiaoshizujin(Integer xiaoshizujin) {
		this.xiaoshizujin = xiaoshizujin;
	}
	/**
	 * 获取：小时租金
	 */
	public Integer getXiaoshizujin() {
		return xiaoshizujin;
	}
	/**
	 * 设置：数量
